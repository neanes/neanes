...
The default font is Source Serif, which (along with Old Standard) supports the Adobe Latin-4 character set, as well as Cyrillic and Greek writing systems. GFS Didot and GFS Porson are bundled for use with Greek texts, and Noto Naskh Arabic is bundled for use with Arabic texts.
