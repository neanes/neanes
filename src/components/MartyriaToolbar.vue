<template>
  <div class="martyria-toolbar">
    <div class="row">
      <button
        class="neume-button"
        @click="setFthora(Fthora.DiatonicNiLow_TopRight)"
      >
        <Neume
      ...
      <button
        class="neume-button"
        @click="setFthora(Fthora.SoftChromaticPa_TopRight)"
      >
        <Neume
          class="red neume fthora"
      ...
      <button
        class="neume-button"
        @click="setFthora(Fthora.SoftChromaticThi_TopRight)"
      >
        <Neume
          class="red neume fthora"
      ...
      <button
        class="neume-button"
        @click="setFthora(Fthora.HardChromaticPa_TopRight)"
      >
        <Neume
          class="red neume fthora"
      ...
      <button
        class="neume-button"
        @click="setFthora(Fthora.HardChromaticThi_TopRight)"
      >
        <Neume
          class="red neume fthora"
      ...
      <button
        class="neume-button"
        @click="setFthora(Fthora.GeneralFlat_TopRight)"
      >
        <Neume class="red neume fthora" :neume="Fthora.GeneralFlat_TopCenter" />
      </button>
      <button
        class="neume-button"
        @click="setFthora(Fthora.GeneralSharp_TopRight)"
      >
        <Neume
          class="red neume fthora"
      ...
      <button
        class="neume-button"
        @click="setFthora(Fthora.Enharmonic_TopRight)"
      >
        <Neume class="red neume fthora" :neume="Fthora.Enharmonic_TopCenter" />
      </button>
      <span class="space"></span>
      <button class="neume-button" @click="setFthora(Fthora.Zygos_TopRight)">
        <Neume class="red neume fthora" :neume="Fthora.Zygos_TopCenter" />
      </button>
      <button class="neume-button" @click="setFthora(Fthora.Kliton_TopRight)">
        <Neume class="red neume fthora" :neume="Fthora.Kliton_TopCenter" />
      </button>
      <button class="neume-button" @click="setFthora(Fthora.Spathi_TopRight)">
