    ...
    <div class="row">
      ...
      <template v-if="!element.auto">
        ...
        <select
          :value="element.note"
          @change="
            $emit('update:note', ($event.target as HTMLInputElement).value)
          "
        >
        ...
        <select
          :value="element.scale"
          @change="
            $emit('update:scale', ($event.target as HTMLInputElement).value)
          "
        >
...
export default class ToolbarMartyria extends Vue {
  ...
  get fthoraNotes() {
    if (
      ...
      return [
        { label: 'Di', value: ScaleNote.Thi },
        { label: 'Vou', value: ScaleNote.Vou },
      ];
    } else if (
      ...
      return [
        { label: `Ni'`, value: ScaleNote.NiHigh },
        { label: 'Ke', value: ScaleNote.Ke },
        { label: 'Ga', value: ScaleNote.Ga },
      ];
    } else if (
