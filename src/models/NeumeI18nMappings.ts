...
export const ROOT_SIGN_LABEL_SELECTORS: Record<RootSign, ModelSelector> = {
  ...
  [RootSign.SoftChromaticPaRootSign]: ($) =>
    $.model.neume.rootSign.softChromaticGa,
...
const MODE_SIGN_LABEL_SELECTORS: Partial<Record<ModeSign, ModelSelector>> = {
  ...
  [ModeSign.Alpha]: ($) => $.model.neume.rootSign.ananes,
  [ModeSign.Nana]: ($) => $.model.neume.rootSign.nana,
  [ModeSign.VarysZo]: ($) => $.model.neume.rootSign.varys,
  [ModeSign.Delta]: ($) => $.model.neume.rootSign.neagie,
  [ModeSign.NanaOld]: ($) => $.model.neume.rootSign.nana,
  [ModeSign.Legetos]: ($) => $.model.neume.rootSign.legetos,
