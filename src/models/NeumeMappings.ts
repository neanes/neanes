import { Neume, TimeNeume, QuantitativeNeume, Fthora, Accidental, TempoSign, VocalExpressionNeume, RootSign, Note, GorgonNeume, ModeSign, MeasureBar } from '@/models/Neumes';
...
export const neumeMap = new Map<Neume, NeumeMapping>([
         ...
         [
           ...
           { fontFamily: "EzFthora", text: "7" },
         ],
         [
           Fthora.HardChromaticPa_TopCenter,
           { fontFamily: "EzFthora", text: "1" },
         ],
         [
           Fthora.HardChromaticThi_TopCenter,
           { fontFamily: "EzFthora", text: "6" },
         ],
         [
           Fthora.SoftChromaticPa_TopCenter,
           { fontFamily: "EzFthora", text: "4" },
         ],
         [
           Fthora.SoftChromaticThi_TopCenter,
           { fontFamily: "EzFthora", text: "2" },
         ],
         ...
         [
           Fthora.DiatonicNiHigh_TopRight,
           { fontFamily: "EzFthora", text: "&" },
         ],
         [
         ...
         [
           Fthora.HardChromaticThi_TopRight,
           { fontFamily: "EzFthora", text: "^" },
         ],
         [
           Fthora.SoftChromaticPa_TopRight,
           { fontFamily: "EzFthora", text: "$" },
         ],
         [
         ...
         [
           ...
           { fontFamily: "EzFthora", text: "e" },
         ],
         [
           Fthora.GeneralSharp_BottomRight,
           { fontFamily: "EzFthora", text: "E" },
         ],
         ...
         [
           ...
           { fontFamily: "EzFthora", text: "t" },
         ],
         [
           Fthora.GeneralFlat_BottomRight,
           { fontFamily: "EzFthora", text: "T" },
         ],
         ...
         [
           VocalExpressionNeume.AntikenomaShort,
           { fontFamily: "Psaltica", text: "}" },
         ],
         [
         ...
         [
           ModeSign.OligonPlusKentemata,
           { fontFamily: "EzSpecial2", text: "y" },
         ],
