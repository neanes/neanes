...
describe('PlaybackService', () => {
  ...
  describe('computePlaybackSequence', () => {
    ...
    it('should calculate the correct zo attractions - zo natural on ascent', () => {
      const service = new PlaybackService();
      ...
      elements.push(getModeKey(4, Scale.Diatonic, ScaleNote.Vou));
      elements.push(getMartyria({ auto: false, note: Note.Thi }));
      elements.push(getNote(QuantitativeNeume.Ison));
      elements.push(getNote(QuantitativeNeume.Oligon));
      elements.push(getNote(QuantitativeNeume.Oligon));
      elements.push(getNote(QuantitativeNeume.Oligon));
    ...
    it('should calculate the correct zo attractions - ke sharp when returning to zo', () => {
      const service = new PlaybackService();
      ...
      const expectedFrequencies = [
        getDiatonicFrequency(ScaleNote.NiHigh),
        getDiatonicFrequency(ScaleNote.ZoHigh),
        getDiatonicFrequency(ScaleNote.Ke, -options.defaultAttractionZoMoria),
        getDiatonicFrequency(ScaleNote.ZoHigh),
      ];
