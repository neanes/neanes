...
`;
  ...
  getDropCapAdjustment(pageSetup: PageSetup) {
    ...
    const font = `${pageSetup.dropCapDefaultFontStyle} normal ${pageSetup.dropCapDefaultFontWeight} ${pageSetup.dropCapDefaultFontSize}px/${pageSetup.dropCapDefaultLineHeight ?? 'normal'} "${pageSetup.dropCapDefaultFontFamily}"`;
